                        ...
                        @can('department_access')
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                                    type="button" role="tab" aria-controls="home" aria-selected="true">Department
                                    List</button>
                            </li>
                        @endcan
                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="container-fluid d-flex justify-content-center mb-3">
                                        <h5 class="input-title">List Of Departments</h5>
                                    </div>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($variables['department'] as $key => $data)
                                                <tr>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="card">
                                <div class="card-body">
                                    <div class="container-fluid d-flex justify-content-center mb-3">
                                        <h5 class="input-title">Add department</h5>
                                    </div>

                                    <!-- Vertical Form -->
                                    <form class="row g-3 needs-validation" method="post"
                                        action="{{ route('department.store') }}" novalidate>
                                        @csrf
                                            ...
                                            <div class="col-4">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="text" class="form-control" id="department"
                                                        name="title" placeholder="Department*" required>
                                                    @error('title')
