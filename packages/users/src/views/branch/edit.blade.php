                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="container-fluid d-flex justify-content-center mb-3">
                                <h5 class="input-title">Edit Branches</h5>
                            </div>

                            <!-- Vertical Form -->
                            <form class="row g-3 needs-validation" method="post"
                                action="{{ route('branch.update', $item->id) }}" enctype="multipart/form-data" novalidate>
                                @csrf
                                @method('PUT')
                                <div class="container-fluid p-2 input-container1">
                                    <div class="row">
                                        <div class="col-4">
                                            <label for="branch-code" class="input-label">Branch Code</label>
                                            <div class="input-group has-validation">
                                                <input type="text" class="form-control" id="branch_code"
                                                    value="{{ old('branch_code', $item->branch_code) }}" name="branch_code"
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="text" class="form-control" id="link"
                                                    value="{{ old('link', $item->link) }}" name="link"
                                                ...
                                                <select id="province" class="form-select" name="province" required>
                                                    ...
                                                    @foreach (config('province') as $val)
                                                        <option value={{ $val['value'] }}
                                                            {{ $item->province == $val['value'] ? 'selected' : '' }}>
                                                            {{ $val['name'] }}</option>
                                                    @endforeach
                                                </select>
                                                @error('province')
                                        ...
                                        <div class="col-3">
                                            <div class="input-group has-validation">
                                                <input type="text" class="form-control" id="district"
                                                    value="{{ old('district', $item->district) }}" name="district"
                                        ...
                                        <div class="col-3">
                                            <div class="input-group has-validation">
                                                <input type="text" class="form-control" id="local_body"
                                                    value="{{ old('local_body', $item->local_body) }}" name="local_body"
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="text" class="form-control" id="contact_no"
                                                    value="{{ old('contact_no', $item->contact_no) }}" name="contact_no"
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="text" class="form-control" id="fax_no"
                                                    value="{{ old('fax_no', $item->fax_no) }}" name="fax_no"
