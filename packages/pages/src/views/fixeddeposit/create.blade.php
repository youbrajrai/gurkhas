                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="container-fluid d-flex justify-content-center mb-3">
                                <h5 class="input-title">Add Fixed Deposit</h5>
                            </div>

                            <!-- Vertical Form -->
                            <form class="row g-3 needs-validation" method="post" action="{{ route('fixeddeposit.store') }}"
                                novalidate>
                                @csrf
                                ...
                                <table class="table table-striped table-hover" id="table1">
                                    ...
                                    <tbody id="tbody" style="text-align: center">
                                        ...
                                        <td class="text-left">
                                            <input type="text"
                                                class="form-control @error('individual[]') is-invalid @enderror"
                                                name="individual[]" id="individual[]" placeholder="Individual*" required>
                                            @error('individual[]')
                                                <span class="text-danger" role="alert">
                                                    <p>{{ $message }}</p>
                                                </span>
                                        ...
                                        <td class="text-left">
                                            <input type="text"
                                                class="form-control @error('individual_remit[]') is-invalid @enderror"
                                                name="individual_remit[]" id="individual_remit[]"
                                                placeholder="Individual(Remit)*" required>
                                        ...
                                        <td class="text-left">
                                            <input type="text"
                                                class="form-control @error('institutional[]') is-invalid @enderror"
                                                name="institutional[]" id="institutional" placeholder="Institutional*"
                                                required>
                                            @error('institutional[]')
                                                <span class="text-danger" role="alert">
                                                    <p>{{ $message }}</p>
                                        ...
                                        <td class="text-left">
                                            <input type="text"
                                                class="form-control @error('institutional_renew[]') is-invalid @enderror"
                                                name="institutional_renew[]" id="institutional_renew"
                                                placeholder="Institutional(Bidding)*" required>
