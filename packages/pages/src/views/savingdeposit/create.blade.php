                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="container-fluid d-flex justify-content-center mb-3">
                                <h5 class="input-title">Add Saving Deposit</h5>
                            </div>

                            <!-- Vertical Form -->
                            <form class="row g-3 needs-validation" method="post"
                                action="{{ route('savingdeposit.store') }}" novalidate>
                                @csrf
                                    ...
                                    <tbody id="tbody" style="text-align: center">
                                        ...
                                        <td class="text-left">
                                            <input type="text"
                                                ...
                                                name="min_balance[]" id="min_balance[]" placeholder="Minimum Balance*"
                                                required>
                                            @error('min_balance[]')
                                                <span class="text-danger" role="alert">
                                                    <p>{{ $message }}</p>
                                        ...
                                        <td class="text-left">
                                            <button class="btn remove" type="button"
                                                style="background-color: #b80000; color:white">Remove</button>
                                        </td>
                                    </tbody>
                                </table>
                                <div class="row">
