...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Interest Type Management</h1>
        </div><!-- End Page Title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="container-fluid d-flex justify-content-center mb-3">
                                <h5 class="input-title">Edit Interest Head</h5>
                            </div>

                            <!-- Vertical Form -->
                            <form class="row g-3 needs-validation" method="post"
                                action="{{ route('interesthead.update', $item->id) }}" novalidate>
                                @csrf
                                @method('PUT')
                                <div class="container-fluid p-2 input-container1">
                                    <div class="row">
                                        <div class="col-4">
                                            <label for="vendor-type" class="input-label">Interest Type</label>
                                            <div class="input-group has-validation">
                                                <input type="text" class="form-control" id="vendor-type" name="title"
                                                    value="{{ old('title', $item->title) }}" placeholder="Interest Type*"
                                                    required>
                                                @error('title')
