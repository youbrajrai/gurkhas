          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <!-- Vertical Form -->
                <form class="row g-3 needs-validation" method="post" action="{{route('noticetype.store')}}" novalidate >
                    @csrf
                  <div class="container-fluid p-2 input-container1">
                    <div class="col-4">
                      <label for="notice-type" class="input-label">Notice Type</label>
                      <div class="input-group has-validation">
                          <input type="text" class="form-control" id="notice-type" name="title" placeholder="Notice Type*" required>
                          @error('title')
