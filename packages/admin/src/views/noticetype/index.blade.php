            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        @can('noticetype_access')
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                                    type="button" role="tab" aria-controls="home" aria-selected="true">Notice
                                    Types</button>
                            </li>
                        @endcan
                        @can('noticetype_create')
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                    type="button" role="tab" aria-controls="profile" aria-selected="false">Add Notice
                                    Types</button>
                            </li>
                        @endcan
                    </ul>
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="container-fluid d-flex justify-content-center mb-3">
                                        <h5 class="input-title">List Of Notice Types</h5>
                                    </div>
                                    ...
                                    <table class="table text-nowrap table-striped" id="table" class="display nowrap"
                                        ...
                                        <tbody>
                                            @foreach ($variables['noticetype'] as $key => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="container-fluid d-flex">
                                                            @can('documenttype_edit')
                                                                <a href="{{ route('noticetype.edit', $data->id) }}"><i
                                                                        class="bi bi-pencil-square"></i></a>
                                                            @endcan
                                                            @can('documenttype_delete')
                                                                <form action="{{ route('noticetype.destroy', $data->id) }}"
                                                                    method="POST">
                                                                    @csrf @method('DELETE')
                                                                    <button
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="card">
                                <div class="card-body">
                                    <div class="container-fluid d-flex justify-content-center mb-3">
                                        <h5 class="input-title">Add Notice Types</h5>
                                    </div>

                                    <!-- Vertical Form -->
                                    <form class="row g-3 needs-validation" method="post"
                                        action="{{ route('noticetype.store') }}" novalidate>
                                        @csrf
                                        <div class="container-fluid p-2 input-container1">
                                            <div class="col-4">
                                                <label for="notice-type" class="input-label">Notice Type</label>
                                                <div class="input-group has-validation">
                                                    <input type="text" class="form-control" id="notice-type"
                                                        name="title" placeholder="Notice Type*" required>
                                                    @error('title')
