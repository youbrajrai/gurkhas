...
@section('content')
    <main>
        ...
        <div class="container-fluid p-0 m-0 d-flex justify-content-end align-items-center"
            ...
            <h2 style="padding-right: 15%;"><u>Financial Administration</u></h2>
        </div>
                    ...
                    <div class="col-12 col-md-4 col-lg-3">
                        <div class="card profile-card d-flex justify-content-center align-items-center">
                            <div class="card d-flex justify-content-center  align-items-center  bg-light p-2"
                                style="width: 90%; margin-top: 120px;"><img class="leave-profile" src="../images/team1.png"
                                    class="rounded float-left" alt="Avatar" width="200px"
                                    style="border-radius: 50%; margin-top: -100px;">
                                <h5 class="pt-2">Ram Hari Acharya</h5>
                                <span class="h8">Loan Approver</span>
                            </div>
                            <span class="profile-body">Baneshwor, Kathmandu</span>
                            <span class="profile-body">9856743256</span>
                            <span class="profile-body">binodchaudhari@gmail.com</span>
                        ...
                        <div class="card profile-card d-flex justify-content-center align-items-center">
                            <div class="card d-flex justify-content-center  align-items-center  bg-light p-2"
                                style="width: 90%; margin-top: 120px;"><img class="leave-profile"
                                    src="../images/team1.png" class="rounded float-left" alt="Avatar" width="200px"
                                    style="border-radius: 50%; margin-top: -100px;">
                                <h5 class="pt-2">Ram Hari Acharya</h5>
                                <span class="h8">Loan Approver</span>
                            </div>
